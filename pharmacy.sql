...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 29, 2023 at 09:30 AM
...
CREATE TABLE `admin_credentials` (
  ...
  `CONTACT_NUMBER` varchar(20) COLLATE utf16_bin NOT NULL,
...
('admin', 'admin123', 'New Farmacy', 'Raipur Chhattisgarh', 'admin@gmail.com', '9876543210', 0);
...
(15, 'Test Customer', '1234567890', 'Test Customer Address', 'Test Doctor', 'Test Doctor Address');
...
(3, 4726.8, '2023-04-29', 15, 5252, 525.2);
...
(6, 'Test Medicine', '2', 'Dilantin', 'Test LK'),
(7, 'Paracetamol ', '10', 'Acetaminophen ', 'Test Lk');
...
('Test LK', 2500, 1, '2023-04-29', 2450, 'PAID');
...
INSERT INTO `sales` (`CUSTOMER_ID`, `INVOICE_NUMBER`) VALUES
(15, 3);
...
(30, 'Test Lk', 'testlk@gmail.com', '9876543210', 'Test Address');
